...
\maketitle
\tableofcontents
\input{includes/chap_I_introduction}
\input{includes/chap_II_parametric}
\input{includes/chap_III_nonparametric}
\input{includes/chap_IV_PH_models}
\input{includes/chap_V_mortality_table}
% \input{includes/chap_V_smoothing}
